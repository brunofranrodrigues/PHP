...
if($_POST['blk']) {
	...
	$Blk = new Blk;
	$filtro= "blk = '" . $_POST['blk'] ."'";
	$resultado = $Blk->listar($filtro);
 ...
 echo '<div id="conteudo">
        <div class="wrapper">
      		<h2>SQUID IP: INSERIR</h2>
            <p>Digite no campo abaixo o IP que deseja bloquear o acesso a internet:</p>
            <form method="post" action="tblkInserir.php" >
             <input type="text" name="blk" value="" class="form-dados-inserir" maxlength="256"/>
